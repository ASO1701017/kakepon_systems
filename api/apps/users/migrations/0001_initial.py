# Generated by Django 3.0.7 on 2020-06-18 18:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_level', models.CharField(choices=[('revel1', 'レベルⅠ'), ('revel2', 'レベルⅡ'), ('revel3', 'レベルⅢ')], default='male', max_length=7, verbose_name='身体活動レベル')),
                ('account_gender', models.CharField(choices=[('male', '男性'), ('female', '女性'), ('secret', '非公開')], default='male', max_length=6, verbose_name='性別')),
